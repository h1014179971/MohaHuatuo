...
public class IOSPlatform : PlatformFactory
{
    ...
    public override void ToAskIDFACustomAlertView()
    {
        IOSPlatformWrapper.ToAskIDFACustomAlertView();
    }
    ...
    {
        Debug.Log("IOSPlatform showInterAd Action");
        IOSPlatformWrapper.showInterAd(actionCallBack);
    }
