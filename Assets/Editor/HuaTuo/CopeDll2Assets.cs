...
namespace Huatuo
{
    public class CopeDll2Assets 
    {
        ...
        static void Copy(BuildTarget target)
        {
            ...
            string aotDllDir = $"{EditorHelper.AssembliesPostIl2CppStripDir}/{target}";
